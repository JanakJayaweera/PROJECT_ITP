 ...
 * @author USER
 */
public class addUpdateStock extends javax.swing.JInternalFrame {
   ...
   ResultSet rs = null;
    ...
    public void tableLoad2(int vid)
    {
       ...
       try  {
                ...
                String sql = "SELECT * FROM stock WHERE ID = '"+vid+"' ";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                Table1.setModel(DbUtils.resultSetToTableModel(rs));
            }
    ...
    private void initComponents() {
        ...
        vIDlabel.setText("Stock ID will assign automatically");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(vnumbertxt, javax.swing.GroupLayout.DEFAULT_SIZE, 375, Short.MAX_VALUE)
        ...
        Table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock ID", "Name", "Description", "Supplier", "Unit Price", "Stocks"
            }
        ) {
