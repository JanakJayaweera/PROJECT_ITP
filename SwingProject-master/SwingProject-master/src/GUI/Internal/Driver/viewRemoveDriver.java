...
public class viewRemoveDriver extends javax.swing.JInternalFrame {
   ...
   ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Set Driver not Employeed to the Factory");

        driverIDR.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        driverIDR.setText("Selected Driver ID will appear here");

        driverFNameR.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        driverFNameR.setText("Selected Driver First name will appear here");
        ...
        driverLNameR.setText("Selected Driver Last Name will appear here");
