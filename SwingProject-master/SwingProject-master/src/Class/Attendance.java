...
public class Attendance {
        ...
        private String FName,LName,Date,On,Off;
        private int id;
        ...
        public Attendance(int pid, String pdate)
        {
        ...
        public Attendance(String pfname,String plname,String pdate,String pon,String poff, int pid, int presult){
             con = DBconnect.connect();
        ...
        public Attendance(String EID,String pfname,String plname,String pdate,String pon,String poff, javax.swing.JTable pTable1)
        {
            con = DBconnect.connect();
